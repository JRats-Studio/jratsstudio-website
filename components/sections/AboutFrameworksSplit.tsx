...
export const AboutFrameworksSplit = () => {
  return (
    <section className="bg-black relative overflow-hidden py-20">
      ...
      <div className="relative z-10">
        <div className="bg-[#000000] mt-12 mb-20 pt-10 pb-10">
              <p className="font-heading text-white text-4xl uppercase tracking-wider text-center mb-6 ">
                Powered By
              </p>
              <LogoLoop
                logos={techLogos}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="bg-[#000000] border border-white/ rounded-2xl p-8 md:p-12">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="font-mono text-[#08cb00] text-md tracking-[0.2em] uppercase mb-4">
              / WHO WE ARE
            </h3>
            <h2 className="font-heading text-6xl sm:text-5xl md:text-6xl text-white uppercase tracking-tight mb-6">
              Hackers of the <span className="text-gradient-premium">Humdrum</span>
            </h2>
            <div className="space-y-4 text-gray-300 font-mono text-xl md:text-xl leading-relaxed max-w-4xl">
              <p>
                We build digital products that stir emotions and drive results. In an era where AI threatens to flatten creativity, we ensure the human spark stays at the center.
              </p>
              <p>
                Our approach is simple: automate the repetitive, amplify the creative. We leverage cutting-edge AI and modern tech stacks not to replace human insight, but to free it.
              </p>
              <p className="text-[#08cb00]">
                No templates. No shortcuts. Just intentional, human-powered innovation fused with intelligent automation.
              </p>
            </div>
          </motion.div>
