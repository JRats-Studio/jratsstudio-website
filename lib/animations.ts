...
// Text reveal variants (per character)
...
export const hoverGlow: Variants = {
  initial: {
    boxShadow: "0 0 0px rgba(8, 203, 0, 0)",
  },
  hover: {
    boxShadow: "0 0 20px rgba(8, 203, 0, 0.5)",
    transition: {
      duration: 0.3,
    },
  },
...
// Parallax fade (used for hero-like sections)
